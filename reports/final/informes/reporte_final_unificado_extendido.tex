...
Como lectura adicional de negocio, tambien se construyo una tabla \textit{lift/gain} en 10 deciles sobre los \textbf{clientes activos en agosto de 2018}. En esta subpoblacion operativa, la tasa base premium es de \textbf{19.40\%}. El \textbf{primer decil} captura \textbf{32.32\%} de los premium reales y alcanza una tasa premium interna de \textbf{62.69\%}, equivalente a un \textbf{lift de 3.23x}. Dicho de otro modo, el ranking del modelo multiplica por mas de tres la densidad esperada de premium en el tramo mas alto del score dentro de la base activa, lo que lo vuelve util para priorizacion comercial sin recurrir a una separacion artificial sobre toda la base de clientes.
