...
Como complemento de negocio, se evaluó el ranking del score mediante una tabla de \textit{lift/gain} en 10 deciles del backtest. El resultado fue extremo: el \textbf{primer decil} concentra el \textbf{100\%} de los premium reales del backtest y exhibe un \textbf{lift de 10.00x}. Esto no significa que dicho decil sea 100\% premium; su tasa premium interna es de \textbf{13.04\%}, frente a una tasa base global de apenas \textbf{1.30\%}. La conclusión es doble: el score sirve muy bien para priorización comercial, pero el escenario de agosto de 2018 es también extraordinariamente separable.
