...
Además del umbral operativo, el docente solicitó validar la capacidad del score como ranking comercial. Para esta lectura usamos solo los \textbf{clientes activos en agosto de 2018} (\texttt{total\_orders > 0}), con el fin de evaluar la priorización sobre la población realmente operativa de la ventana backtest. Luego ordenamos esos clientes por probabilidad predicha descendente y los dividimos en \textbf{10 deciles del mismo tamaño}. En cada decil medimos cuántos clientes premium reales aparecen, cuántos se acumulan y cuál es el \textit{lift} respecto a una selección aleatoria.
...
\begin{table}[h]
\centering
\caption{Tabla de Deciles Lift/Gain sobre Clientes Activos de Agosto 2018}
...
Los resultados muestran una priorización fuerte pero más realista sobre la población activa. Entre \textbf{6,460 clientes activos} y \textbf{1,253 premium reales}, el \textbf{primer decil} captura \textbf{32.32\%} de todos los premium y alcanza una tasa premium interna de \textbf{62.69\%}, frente a una tasa base de \textbf{19.40\%}. Esto equivale a un \textbf{lift de 3.23x} en el tramo más alto del ranking. Al ampliar la cobertura al \textbf{20\%} superior de clientes activos, el modelo ya captura \textbf{49.56\%} de los premium reales. La conclusión es más defendible para negocio: el score no es perfecto, pero \textbf{sí ordena de forma útil a los clientes activos}, concentrando una fracción sustantiva del valor comercial en los primeros deciles.

\begin{figure}[h]
  \centering
  \includegraphics[width=\columnwidth]{sprint_04_backtest_gain_lift_active_august.png}
  \caption{Responses por decil y curvas acumuladas de gain/lift sobre clientes activos en agosto de 2018. El ranking concentra una porción importante de premium reales en los primeros deciles sin caer en la separación extrema observada sobre la base completa.}
