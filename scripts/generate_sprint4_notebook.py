...
notebook = {
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Unimos df_eval con total_spent de la master table de backtest para calcular gasto capturado\n",
    ...
    "}).merge(master_backtest[['customer_unique_id', 'total_spent']], on='customer_unique_id', how='left')\n",
    "\n",
