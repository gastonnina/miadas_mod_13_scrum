...
- Categoricas: `customer_unique_id, customer_city, customer_state, main_payment_type, top_category`
...
| `top_category` | `object` | 89713 | 93.36% | 65 |
| `avg_item_price` | `float64` | 89685 | 93.33% | 1549 |
| `max_item_price` | `float64` | 89685 | 93.33% | 1424 |
| `avg_review_score` | `float64` | 89663 | 93.31% | 9 |
| `avg_estimated_delivery_days` | `float64` | 89636 | 93.28% | 77 |
| `avg_payment_installments` | `float64` | 89636 | 93.28% | 25 |
| `canceled_orders` | `float64` | 89636 | 93.28% | 3 |
| `cancellation_rate` | `float64` | 89636 | 93.28% | 3 |
| `customer_lifetime_days` | `float64` | 89636 | 93.28% | 19 |
